...
if (!file.exists("results/jagsoutput.Rdata")){
  ...
  inits <- function() {list (z=zst, alpha.p=rep(runif(1, -2, 2), nyear), 
                             muphi1=rnorm(1), sigmaphi1=runif(1,0,5),
                             muphi2=rnorm(1), sigmaphi2=runif(1,0,5),
                             muphi3=rnorm(1), sigmaphi3=runif(1,0,5),
                             muphi4=rnorm(1), sigmaphi4=runif(1,0,5),
                             mugam1=rnorm(1), sigmagam1=runif(1,0,5),
                             mugam2=rnorm(1), sigmagam2=runif(1,0,5),
                             mugam3=rnorm(1), sigmagam3=runif(1,0,5),
                             mugam4=rnorm(1), sigmagam4=runif(1,0,5),
