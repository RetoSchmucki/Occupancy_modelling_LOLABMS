...
#***************************************
# ==============================================================
setwd("/home/reto/Documents/LOLA_BMS/Occupancy Model project/Occupancy_modellingNEWJUNE/countries_UNI_2000_sd_1/Aphantopus_hyperantus")
...
jags_model <- "OCCmodel_1_jagscript_tidev_zone.txt"
        ...
        "Marsaglia-Multicarry", "Super-Duper", "Mersenne-Twister")) 
{
    ...
    fit <- mcmc2bugs(samples, model.file = model.file, program = "jags", 
        ...
        n.thin = n.thin)[c("sims.list","summary","pD","DIC")]
...
set.seed(1234)
out <- jags(data, inits, parameters, jags_model, n.chains=nch, n.iter = ni, n.thin=nt, n.burnin=nb, DIC=TRUE, working.directory=NULL)
