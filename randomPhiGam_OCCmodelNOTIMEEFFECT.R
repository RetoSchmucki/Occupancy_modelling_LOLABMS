...
#========================
for (t in 2:nyear) {
	beta.phi1[t-1] <- muphi1 + epsilonphi1[t-1]
...
#========================
for (t in 2:nyear) {
	beta.phi2[t-1] <- muphi2 + epsilonphi2[t-1]
...
#========================
for (t in 2:nyear) {
	beta.phi3[t-1] <- muphi3 + epsilonphi3[t-1]
...
#========================
for (t in 2:nyear) {
	beta.phi4[t-1] <- muphi4 + epsilonphi4[t-1]
...
#========================
for (t in 2:nyear) {
beta.gam1[t-1] <- mugam1 + epsilongam1[t-1]
...
#========================
for (t in 2:nyear) {
beta.gam2[t-1] <- mugam2 + epsilongam2[t-1]
...
#========================
for (t in 2:nyear) {
beta.gam3[t-1] <- mugam3 + epsilongam3[t-1]
...
#========================
for (t in 2:nyear) {
beta.gam4[t-1] <- mugam4 + epsilongam4[t-1]
